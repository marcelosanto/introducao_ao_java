...
import composicao.entities.enums.WokerLevel;
...
public class Workers {
    public static void main(String[] args) throws ParseException {
        ...
        Worker worker = new Worker(workerName, WokerLevel.valueOf(workerLevel), baseSalary, new Department(departmentName));
